<template>
  <div class="relative p-4" ref="board">
    <BorderBox7 :color="['white', 'white']" :key="width">
      ...
      <div
        class="border border-white w-80 h-40 top-80 left-8 absolute p-4"
        v-if="isShow"
      >
        <div class="flex items-center justify-between">
          <p class="mb-2 font-extrabold" style="letter-spacing: 0.1em">
            神经网络1
          </p>
          <p
            class="mb-2 font-extrabold"
        ...
        <div class="flex items-center justify-start">
          <span
            class="bg-yellow-500 rounded-full aspect-square w-4 mr-4"
          ></span>
